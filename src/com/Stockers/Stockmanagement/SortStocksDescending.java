...
public class SortStocksDescending {
	...
	public void stocksDescending(double[] arr, int first, int last ) {
		int mid;
		if(first<last) {
			mid = (first+last)/2;

			stocksDescending(arr,first,mid);
			stocksDescending(arr,mid+1,last);
